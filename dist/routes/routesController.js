 ...
 *
 */
router.post(routes.CREATE_BLOG, blogController_1.default.createBlog);
/**
 * @swagger
 * /api/articles:
 *  get:
 ...
 *
 */
router.get(routes.GET_BLOG, blogController_1.default.getBlog);
/**
 * @swagger
 * /api/articles/{id}:
 *  get:
 ...
 *
 */
router.get(routes.GET_BLOG_BY_ID, blogController_1.default.getBlogId);
/**
 * @swagger
 * /api/articles/search:
 *  get:
 ...
 *
 */
router.get(routes.SEARCH_BLOG, blogController_1.default.searchBlog);
/**
 * @swagger
 * /api/articles/{id}:
 *  put:
 ...
 *
 */
router.put(routes.UPDATE_BLOG, blogController_1.default.updateBlog);
/**
 * @swagger
 * /api/articles/{id}:
 *  delete:
 ...
 *
 */
router.delete(routes.DELETE_BLOG, blogController_1.default.deleteBlog);
